...
function Completion(props) {
  const [initConfetti, setConfetti] = useState(["#5adbff", "#ffffff", "#666"])
  const config = {
    angle: "90",
    spread: 45,
    startVelocity: "63",
    ...
    return (
      <div className="congrats-Wrapper">
        ...
        <div className='iHeartU'>
          <svg className="svgHeart" viewBox="0, 0, 400,400">
        ...
        <div className="confettiCannon"><Confetti className="prettyColors" active={ props.celebrate } config= {config}/></div>
      </div>
    )
  }
